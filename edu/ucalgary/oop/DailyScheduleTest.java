...
public class DailyScheduleTest {
    ...
    public void testConstructorGoodInput() {
        ...
        animals.add(new Fox(7, "Slinky", "fox", "NOCTURNAL", false));
        ArrayList<Task> tasks = new ArrayList<Task>();
        tasks.add(new Task(2, "Rebandage leg wound", 20, 1, "MEDICAL"));
        tasks.add(new Task(11, "feed fox", 10, 3, "FEEDING"));
        DailySchedule schedule = new DailySchedule(animals, tasks, date);
        assertEquals(2, schedule.getTaskAndTime().size());
        assertEquals(date, schedule.getCurrDate());
        assertEquals("00:00\n* Feeding - fox (Slinky)\n", schedule.getTaskAndTime().get(0));
        assertEquals("19:00\n* Rebandage leg wound (Slinky)\n", schedule.getTaskAndTime().get(1));
    }
    ...
    public void testGetTaskAndTime() {
        ...
        tasks.add(new Task(11, "feed fox", 10, 3, "FEEDING"));
        DailySchedule schedule = new DailySchedule(animals, tasks, date);
        assertEquals(expected, schedule.getTaskAndTime());
    }
